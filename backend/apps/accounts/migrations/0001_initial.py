    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('SALES_REP', 'Sales Rep'), ('SALES_MANAGER', 'Sales Manager'), ('FINANCE', 'Finance / Operations'), ('CUSTOMER', 'Customer')], default='SALES_REP', max_length=20)),
